...
CREATE TABLE [dbo].[FacebookFirmOrder]( [TradeID] [int] NOT NULL, [TradeType] [varchar](50) NOT NULL, [SecurityType] [varchar](50) NOT NULL, [SecurityName] [varchar](50) NOT NULL, [Price] [float] NOT NULL, [Quantity] [int] NOT NULL, [Time] [datetime] NOT NULL, CONSTRAINT [PK1_FirmOrder] PRIMARY KEY CLUSTERED ( [TradeID] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] )

CREATE TABLE [dbo].[AppleFirmOrder]( [TradeID] [int] NOT NULL, [TradeType] [varchar](50) NOT NULL, [SecurityType] [varchar](50) NOT NULL, [SecurityName] [varchar](50) NOT NULL, [Price] [float] NOT NULL, [Quantity] [int] NOT NULL, [Time] [datetime] NOT NULL, CONSTRAINT [PK2_FirmOrder] PRIMARY KEY CLUSTERED ( [TradeID] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] )

CREATE TABLE [dbo].[WalmartFirmOrder]( [TradeID] [int] NOT NULL, [TradeType] [varchar](50) NOT NULL, [SecurityType] [varchar](50) NOT NULL, [SecurityName] [varchar](50) NOT NULL, [Price] [float] NOT NULL, [Quantity] [int] NOT NULL, [Time] [datetime] NOT NULL, CONSTRAINT [PK3_FirmOrder] PRIMARY KEY CLUSTERED ( [TradeID] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY] )
